...
ORDER = """
01-pill-x
44-cross-amen 138-seal 136-flash 50-soldout-tee 134-louverse-tank 47-flipclock 49-board-dropnow
...
02-acid-xx 139-xx 140-laugh 141-cry 142-cool 143-melt
87-cross 90-sparkles 84-fire 111-siren 114-headphones
10-club-key 21-teddy-skull 26-tribal-heart 04-tramp-stamp 14-barbed-heart 15-dagger-heart 22-kiss-less3
03-sigil-x 43-scorpion-sigil 27-tribal-eye 28-tribal-cross 17-winged-x 18-spike-collar 13-dagger-cross 19-thorn-star 41-patch-x 32-swallow 25-mask-glyphs
""".split()
...
54-laugh 56-sob 57-plead 58-heart-eyes 59-kiss 60-rage 61-swear 68-cool 72-skull 73-melt 75-mind-blown 83-eyes 102-zipper-mouth
...
| | v2 | v3.1 |
|---|---|---|
| эмодзи в паке | 117 | 49 |
| лиц | 55 (kaomoji) | 6 (кислотный смайл v1: 02, X_X, ржёт, рыдает, визор, тает) |
| из них «0_0» | 9 | 0 |
| логотип | шрифт Michroma «под лого» | трассировка брендового файла 1:1 (`fonts/xtc-logo.svg`, `xtc/logo.py`) во всех 20 местах |
...
**Состав v3.1:** 20 бренд-предметов (таблетка, крест, печать, вспышка, лонгслив SOLD OUT, louverse tank, таймер, DROP NOW, плитки X·T·C, XTC-плитки, коробка, купюры, PSP, сумка, XTC-подтёки, латекс-сердце, таблетка-магнит, сердце-таблетка) · 6 лиц · 5 реакций с логотипом (X-штамп, хром-X, X-пламя, мигалка-X, наушники-X) · 18 тату v1 (ключ, мишка с костями, трайбл-сердца, кинжалы, сигилы, звезда, пластырь, ласточка, маска).
...
| 139–143 лица | кислотный смайл: черты и слёзы — дырки в чёрном диске (негатив), подтёки с кромки; X_X с языком-подтёком |
| 87 / 90 / 114 | логотипный X как штамп с бликом, как хромовая вещь с ✦-вырезами, как чашки наушников |

**Вырезано 68 из 117 v2 + 3 из v3.0:** 48 лиц-kaomoji, 4 руки, 12 бейджей с чужими словами, ?, !, хлопушка, молния, 100, галочка, простые сердца, бокал, ремень/пряжка, штаны, лонгслив-переворот, 4 символа v1 (каша на 24px). Причины по каждому — `REVIEW-v3.md`.
