...
153-lips 154-100xtc 155-star-ring 156-star 157-star-flake 158-clef 159-yes-money
10-club-key 151-skull-x 21-teddy-skull 26-tribal-heart 04-tramp-stamp 22-kiss-less3
...
**Состав v3.7:** 23 бренд-предмета (+ LEGO-голова) · 7 из пака XTCRECORDS (губы, 100%% XTC, кольцо звёзд, звезда, звёздная снежинка, скрипичный ключ, ¥€$) (+ кресты: логотип-крест в плашке, готическая подвеска; разбитое сердце с лого) (таблетка, крест, печать, вспышка, лонгслив SOLD OUT, louverse tank, таймер, DROP NOW, плитки X·T·C, XTC-плитки, коробка, купюры, PSP, сумка, XTC-подтёки, латекс-сердце, таблетка-магнит, сердце-таблетка) · 2 лица (X_X, T_T) · 3 реакции с логотипом (X→T→C, X-пламя, мигалка-X) · 16 тату (ключ, брендовый череп, мишка с костями, трайбл-сердца, сигилы, звезда, пластырь, ворон, маска).
