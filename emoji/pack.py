...
02-acid-xx 139-xx 140-laugh 141-cry 142-cool 143-melt 114-headphones 14-barbed-heart 15-dagger-heart
...
**Состав v3.2:** 20 бренд-предметов (таблетка, крест, печать, вспышка, лонгслив SOLD OUT, louverse tank, таймер, DROP NOW, плитки X·T·C, XTC-плитки, коробка, купюры, PSP, сумка, XTC-подтёки, латекс-сердце, таблетка-магнит, сердце-таблетка) · 2 лица (X_X, T_T) · 4 реакции с логотипом (X-штамп, хром-X, X-пламя, мигалка-X) · 16 тату v1 (ключ, мишка с костями, трайбл-сердца, кинжал, сигилы, звезда, пластырь, ласточка, маска).
