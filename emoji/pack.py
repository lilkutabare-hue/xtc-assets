...
**Состав v3.6:** 23 бренд-предмета (+ LEGO-голова) (+ кресты: логотип-крест в плашке, готическая подвеска; разбитое сердце с лого) (таблетка, крест, печать, вспышка, лонгслив SOLD OUT, louverse tank, таймер, DROP NOW, плитки X·T·C, XTC-плитки, коробка, купюры, PSP, сумка, XTC-подтёки, латекс-сердце, таблетка-магнит, сердце-таблетка) · 2 лица (X_X, T_T) · 3 реакции с логотипом (X→T→C, X-пламя, мигалка-X) · 16 тату (ключ, брендовый череп, мишка с костями, трайбл-сердца, сигилы, звезда, пластырь, ворон, маска).
